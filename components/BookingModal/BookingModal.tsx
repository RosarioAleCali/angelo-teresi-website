  ...
  return (
    ...
    >
      <div ref={modalRef} className="relative w-fit flex flex-col">
        <div className="flex flex-col items-center p-5 border border-transparent rounded-md bg-black/50 shadow-md">
          <div className="flex justify-center gap-5">
            <Link
              className="flex flex-col items-center text-center border border-[#746d75]/30 rounded-sm p-2.5 w-[6.85rem] text-white hover:bg-[#F5F5F5] hover:text-[#333333] hover:underline hover:decoration-tropical hover:decoration-2 hover:underline-offset-1"
              href={links.online}
              target="_blank"
