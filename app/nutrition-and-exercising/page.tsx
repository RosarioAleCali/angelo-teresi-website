...
export default function NutritionAndExercising() {
  ...
  return (
    <div className="fadeInElement flex flex-col justify-start items-center w-full min-h-[calc(100vh-70px)] md:min-h-[calc(100vh-80px)] bg-tiber text-black py-10 px-6 md:px-14">
      <h2 className="fadeInElement text-3xl text-white font-bold mb-4 text-center">
        Nutrizione e Allenamento
      </h2>
      <p className="fadeInElement text-white mb-4 md:max-w-4xl">
      ...
      <div className="flex flex-col md:flex-row md:gap-4 mb-6 md:max-w-4xl">
        <div className="fadeInElement md:w-1/2 w-full flex justify-center">
          <Image
